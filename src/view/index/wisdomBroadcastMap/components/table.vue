    ...
    <el-form ref="form" :model="form">
      ...
      <div class="dataList">
        <div class="flexRow title">
          <span class="flexCenter el-avatar">
            <i class="iconfont icon-lujingaa" /> </span
          >{{ title }}
        </div>
        <ul class="flexCloumn">
          <li
          ...
          >
            ...
            <span class="adress"
              ><p>{{ item.audioDeviceName }}</p></span
            >
            <span class="number">{{ item.onlineStatusText }}</span>
          </li>
        </ul>
      </div>
    </el-form>
...
<script>
import { getAddress } from "api/controlStrategy";
export default {
  data() {
    return {
      form: {
