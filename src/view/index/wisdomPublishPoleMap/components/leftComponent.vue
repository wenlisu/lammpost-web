...
import { getLampPowerWastingInfo } from "@/api/wisdomLightPole";
export default {
  data() {
    return {
      title: "设备信息概览",
  ...
  methods: {
    _getLampPowerWastingInfo() {
      getLampPowerWastingInfo().then((res) => {
        if (res.code === "200") {
