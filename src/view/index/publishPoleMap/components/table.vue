  ...
  <div id="lightTable">
    <el-form ref="form" :model="form">
        ...
        >
            ...
            <span class="adress"><p>{{item.ledDeviceName}}</p></span>
            <span class="number">{{item.power === 0 ? '关' : '开'}}</span>
            </li>
        </ul>
        </div>
    </el-form>
...
export default {
  ...
  methods: {
    ...
    createFilter (queryString) {
      return (restaurant) => {
        return (restaurant.ledDeviceName.toLowerCase().indexOf(queryString.toLowerCase()) > -1);
      };
    },
    handleSelect (item) {
      this.form = {
