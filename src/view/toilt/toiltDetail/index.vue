            ...
            <div class="gents">
              ...
              <div class="gents-right">
                ...
                <div class="gents-text">
                  <p>保洁员：<span>张峰</span></p>
                  <p>保洁次数：<span>3</span></p>
                </div>
              </div>
            </div>
          </div>
        ...
        if (res.code == "200") {
          ...
          for (let j in female) {
            /* if (
              ...
              this.feMaleToiltArr.push(female[j]);
            } */
            if (j === "h2s") {
          ...
          // 今日客流
          const curIn = male.flowIn + female.flowIn;
          // 累计客流
          const allIn = male.flowAll + female.flowAll;
