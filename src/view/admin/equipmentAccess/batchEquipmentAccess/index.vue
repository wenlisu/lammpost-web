<template>
  <div id="batchEquipmentAccess">
    <div class="batchEquipmentAccessMain">
      ...
      <div class="flexCloumn equipmentSelect">
        <div class="listInfo flexCloumn">
          <div class="listItem">
            <div class="listTitle">灯杆列表</div>
            <el-transfer
              filterable
              v-model="lampSelect"
              :data="lampData"
              :titles="['待选灯杆列表', '已选灯杆列表']"
            ></el-transfer>
          </div>
          <div class="listItem">
...
<style lang="less">
#batchEquipmentAccess > .batchEquipmentAccessMain{
  min-height: 100%;
