    ...
    <section>
      <el-table :data="modeTableData" class="hidden-tbody">
        ...
        <el-table-column
          ...
          label="报警位置"
        ></el-table-column>
        <el-table-column prop="callTime" label="开始时间"></el-table-column>
        <el-table-column prop="finishedTime" label="结束时间"></el-table-column>
      </el-table>
...
import { getAlarmCallRecordForPage } from "@/api/screen/newIndex";
export default {
  components: {
    vueSeamlessScroll
  },
