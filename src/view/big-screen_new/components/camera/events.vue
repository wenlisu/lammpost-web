<template>
  ...
  <div class="com-container">
    <div class="com-chart">
      ...
      >
        ...
        <defs>
          <linearGradient
            ...
            id="linearGradient-1"
          >
            <stop stop-color="#398BFF" stop-opacity="0" offset="0%"></stop>
            <stop stop-color="#25EDA0" offset="50.4955403%"></stop>
            <stop stop-color="#39D6FF" offset="100%"></stop>
          </linearGradient>
        </defs>
        <g
          id="确定的效果"
      ...
      <div class="ball"></div>
      <div class="gauge-img" ref="gauge"></div>
      <div class="todayEvents">
        <p class="num">{{ allData.todayEvents }}</p>
        <p class="text">今日事件</p>
      </div>
      <div class="gauge-box">
        <div class="list">
          ...
          <div class="info">
            <p class="p1">人脸识别</p>
            <p class="p2">{{ allData.faceDetectionCount }}<span>个</span></p>
          </div>
        </div>
        <div class="list">
          ...
          <div class="info">
            <p class="p1">入侵侦测</p>
            <p class="p2">
              {{ allData.intrusionDetectionCount }}<span>个</span>
            </p>
          </div>
        </div>
        <div class="list">
          ...
          <div class="info">
            <p class="p1">区域侦测</p>
            <p class="p2">{{ allData.areaDetectionCount }}<span>个</span></p>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    // 获取PIE数据
    getList() {
      this.allData = getLocal("bigScreenNew")["cameraEventStat"];
    }
  }
};
</script>
...
.com-chart {
  ...
  .gauge-box {
    ...
    .list {
      ...
      height: 60px;
      background: #01274f;
      box-shadow: 0px 0px 8px 0px #003c73 inset;
      border: 1px solid;
