<template>
  ...
  <div class="com-container">
    <div class="com-chart" ref="led_today"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    initChart() {
      this.chartInstance = this.$echarts.init(this.$refs.led_today, "chalk");
      const initOption = {
    ...
    getData() {
      let todayData = getLocal("bigScreenNew")["ledPlayStateDay"];
      let dataName = [];
      let dataValue = [[], []];
