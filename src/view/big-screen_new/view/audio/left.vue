<template>
  <div id="callLeft" :class="{ componentView: true, show: show }">
    <div class="part_1">
      <ChartTitle partTitle="广播器今日播放情况分析"/>
      <RadioToday />
    </div>
    <div class="parat_2">
      <ChartTitle partTitle="广播器近七天播放情况分析"/>
      <RadioWeek />
    </div>
  </div>
</template>
...
import RadioToday from '../../components/radio/today'
import RadioWeek from '../../components/radio/week'
export default {
  data() {
    return {
      screenEnergyConsump: {},
