<template>
  <div id="lampLeft" :class="{'componentView': true, 'show': show}">
    <div class="part_1">
      <ChartTitle partTitle="照明灯能耗分析"/>
      <LampEnergry />
    </div>
    <div class="parat_2">
      <ChartTitle partTitle="照明灯亮度分析"/>
      <LampBright />
    </div>
  </div>
</template>
...
import LampBright from '../../components/lamp/brightness'
import LampEnergry from '../../components/lamp/energy'
export default {
  data () {
    return {
      screenEnergyConsump: {},
