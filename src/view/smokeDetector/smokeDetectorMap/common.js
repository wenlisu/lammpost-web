...
export const initMap = (options) => {
  ...
  // });
  options.marks.map((mark, index) => {
    const point = new BMapGL.Point(mark.center[0], mark.center[1]);
    const circle = new BMapGL.Circle(point, 8, {strokeColor: 'blue', strokeWeight: 2, strokeOpacity: 1});
    circle.setZIndex(10);
    map.addOverlay(circle);
    circle.addEventListener('click', (e) => {
      mark.onClick({ ...e, serialNumber: mark.serialNumber });
    });
  });
