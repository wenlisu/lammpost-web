            ...
            <el-col :span="12"
              ...
              >
                ...
                <div class="flexRow videoInfo">
                    ...
                    <!-- <div class="flexCenter playBack" @click="playBack(item.serialNumber)">
                        <i class="iconfont iconshipinhuifang" />
                        视频回放
                    </div> -->
                    <!-- <div class="flexCenter playBack more" @click="handleMore(item.serialNumber)">
                        <i class="iconfont iconshipinhuifang" />
                        更多
                    </div> -->
                </div>
