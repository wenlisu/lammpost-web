...
// 登陆成功获取当前用户可访问的路由信息,添加路由表信息
let whiteList = ['index', 'test', 'testpage1', 'updatePassword', 'error_404',
  'wisdomApplication', 'wisdomAppParkReport', 'smokeAppMap', 'toiltAppMap', 'toiltDetail',
  'illuminationDetail', 'ruleManageEdit', 'equipmentListDetail', 'useManagePage', 'timeTaskDetail',
  'adminWifi', 'wifiDevInfo', 'deviceInfo', 'wifiAPTraffic', 'APTraffic', 'APLoad', 'wifiWarmingNotice', 'warmNotice',
  'createOrder', 'linkageRuleListDetail', 'wisdomWifiEquipment', 'warmDetail', 'wisdomMonitoring', 'productManagementPage', 'lampPoleManagementEdit', 'alarmStatisticsPage', 'faultStatisticPage', 'entranceAlarmEventDetail', 'entranceVisitorInformationDetail', 'dataDetail', 'instrumentAlarm', 'timeTaskDetail', 'illuminationDetail', 'atta_templet', 'orderDetail', 'lightPoleMap', 'lightPoleDetail', 'cameraEvent', 'chargeBaseInfo', 'chargeOperationAnalysis', 'wisdomPublishDetail', 'wisdomPublishPage', 'wisdomVideoDetail', 'warmDetail', 'wisdomWarnDetail', 'faultWarnDetail', 'wisdomWifiEquipment', 'wisdomWifiUserDetail', 'smokeAlarmLinkDetail'
]// 默认白名单
